...
//
//    public PasswordStore() throws KeyStoreException {
...
//    }
//
//    public synchronized void unlockStore(File file, char[] password) throws Exception {
//        protParam = new KeyStore.PasswordProtection(password, "PBEWithHmacSHA256AndAES_256", null);
//        File filePasswordStore = new File(CONFIG_DIR, "passwords.pfx");
...
//
//        try (OutputStream out = new FileOutputStream(new File(CONFIG_DIR, "passwords.pfx"))) {
...
//        }
//
//        if (SessionService.getSettings().isUsingMasterPassword()) {
...
//                        App.getBundle().getString("master_password"), JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null, null,
...
//                            App.getBundle().getString("incorrect_password")) != JOptionPane.YES_OPTION) {
//                        break;
//                    }
//                }
//            } catch (Exception e) {
...
//
//            if (JOptionPane.showConfirmDialog(App.getAppWindow(),
//                    App.getBundle().getString("error_loading_password")) != JOptionPane.YES_OPTION) {
//                break;
//            }
//        }
//        return false;
