 ...
 */
package util.jnafilechooser.api;

import com.sun.jna.Memory;
import com.sun.jna.Native;
import com.sun.jna.WString;
import util.jnafilechooser.win32.Comdlg32;
...
public class WindowsFileChooser
{
	...
	boolean showDialog(Window parent, boolean open) {
		...
		if (approved) {
			final String filePath = WindowsPathUtil.windowsFileDialogPathParse(params.lpstrFile.getByteArray(0, bufferSize));// params.lpstrFile.getString(0);//, true);
