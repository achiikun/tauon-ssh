...
public class SystemLoadPanel extends JPanel {
    ...
    public SystemLoadPanel() {
        ...
        cpuLabel = new JLabel(getBundle().getString("app.info_system_load.cpu_usage"));
        ...
        memoryLabel = new JLabel(getBundle().getString("app.info_system_load.memory_usage"));
        ...
        swapLabel = new JLabel(getBundle().getString("app.info_system_load.swap_usage"));
    ...
    public void refreshUi() {
        this.cpuLabel
                .setText(String.format(getBundle().getString("app.info_system_load.cpu_usage") + ": %.1f", cpuUsage) + "% ");
        this.memoryLabel.setText(String.format(getBundle().getString("app.info_system_load.memory_usage") + ": %.1f",
                memoryUsage)
                + "%"
                + (totalMemory != 0
                ? (", (Total: " + FormatUtils
                .humanReadableByteCount(totalMemory, true)
                + ", " + getBundle().getString("app.info_system_load.used") + ": "
                + FormatUtils.humanReadableByteCount(usedMemory,
                true)
                + ")")
                : ""));
        this.swapLabel.setText(String.format(getBundle().getString("app.info_system_load.swap_usage") + ": %.1f", swapUsage)
                + "% "
                + (totalSwap != 0
                ? (", ( Total: "
                + FormatUtils.humanReadableByteCount(totalSwap,
                true)
                + ", " + getBundle().getString("app.info_system_load.used") + ": " + FormatUtils
